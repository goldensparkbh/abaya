...
$active = 'True-index';
$logo = 'img/';
if((!empty($_SESSION['admin'])) AND ($_SESSION['admin'] == true)){
  ...
  <section>
    ...
    <div class="container mt-5 my-section">
      ...
      <div class="row">
        ...
        // FECTH PRODUCTS
        $sql = "SELECT products.id,title,img,price,business_name
                FROM products,owner_of_business 
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="price_class">Price:  <?php echo $result->price;  echo CURRENCY ?></p>
    ...
    <div class="container mt-5 my-section">
      <h3 class="py-4">Colored Abayas</h3>
      <div class="row">
    ...
    <div class="container mt-5 my-section">
      <h3 class="py-4">Embroidered Abayas</h3>
      <div class="row">
    ...
    <div class="container mt-5 my-section">
      <h3 class="py-4">Winter Collection</h3>
      <div class="row">
